    ...
    <ul class="contacts-list">
      <li class="contact-item">
        ...
        <div class="contact-info">
          ...
          <a href="mailto:bajentingjohnnyboy@gmail.com" class="contact-link">bajentingjohnnyboy@gmail.com</a>
        </div>
      </li>
      <li class="contact-item">
        ...
        <div class="contact-info">
          ...
          <a href="tel:+639919412557" class="contact-link">+63 9919412557</a>
        </div>
      </li>
      <li class="contact-item">
        ...
        <div class="contact-info">
          ...
          <time datetime="2003-01-16">January 16, 2003</time>
        </div>
      </li>
      <li class="contact-item">
